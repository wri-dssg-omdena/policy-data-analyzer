...
class USFR_2(BaseSpider):
    ...
    API_key_file = '/home/propietari/Documents/claus/us_gov_api_key_madeingame.json'
    ...
    def __init__(self):
        ...
        self.API_key = self.import_json(self.API_key_file)["us gov apikey madeingameAdmin"]
